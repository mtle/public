...
<h2>Step 8 - Create normalization rule - Optional</h2>
...
<div>
<h2> Step 9 - Local Interface rule</h2>
...
<h2> Step 10. Routing for traffic generated by the router - Optional</h2>
<p>Services running on the router and configured to use the VPN interface must have their traffic routed to the VPN gateway in order to use the VPN. Note that locally generated traffic is not affected by NAT or by the firewall rule created in Step 8.</p>
