...
pattern:
    name: "frommaster"
    allow-notify: 192.168.yy.31 secure_key
    request-xfr: AXFR 192.168.yy.31@5353 secure_key

    allow-notify: 192.168.yy.33 secure_key
    request-xfr: AXFR 192.168.yy.33@5353 secure_key
